...
public class Dialog {
	...
	public static Customer showCustomerDialog(Customer customer){
		...
		JComponent[] inputs = new JComponent[]{lbName,txtName,lbSurename,txtSurename,lbAddress,txtAddress}; 
		...
		JOptionPane.showOptionDialog(null, inputs, "Benutzer Anlegen", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, null, new String[]{"Speichern","Abbrechen"}, "Speichern");
		...
		return new Customer(txtName.getText(), txtSurename.getText(), txtAddress.getText());
	}
